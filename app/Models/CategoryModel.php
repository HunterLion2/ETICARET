...
class CategoryModel
{
    ...
    public function getActiveCategories()
    {
        ...
        // fetchAll değeri , veritabanından yapılan sorgunun sonucundaki tüm satırları bir dizi olarak döndürür.
    }
    ...
    // Bu değer Çınar Özgürgil gibi girilen değeri => çınar-özgürgil değerine döndürür yani 
    // boşlukları siler ve harfleri küçültür.
    {
