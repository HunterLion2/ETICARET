# **Ürün Detay Sayfası - View Dosyası**

Bu eğitim dokümanında, **ürün detay sayfasının nasıl çalıştığını ve dinamik olarak nasıl veri çekildiğini** öğreneceksiniz. **Bu sayfa, ürün bilgilerini, fiyatı, resimleri ve kullanıcı yorumlarını içeren detaylı bir görünüm sunmaktadır.**

---

## **1. Ürün Resimlerini Gösteren Carousel**
...
### **Ne İşe Yarar?**
✅ **Ürün için bir resim galerisi sunar.**  
✅ `carousel-item` ile **ilk görsel varsayılan olarak aktif belirlenir.**  
✅ `foreach ($galleryImages as $image)` ile **veritabanından gelen ek görseller listelenir.**

---

## **2. Ürün Başlığı, Açıklaması ve Fiyatı**
...
### **Ne İşe Yarar?**
✅ **Ürün adını, kısa açıklamasını ve fiyatını kullanıcıya gösterir.**

---

## **3. Stok Durumu ve Kullanıcı Puanlaması**
...
### **Ne İşe Yarar?**
✅ **Kullanıcılara ürünün puanlamasını ve değerlendirme sayısını gösterir.**  
✅ **Stok durumunu dinamik olarak belirler.**  
...
### **Ne İşe Yarar?**
✅ **Kullanıcının ürün miktarını seçmesini sağlar.**
✅ **Ürün ID’sini ve kullanıcı ID’sini gizli alanlarla (hidden input) gönderir.**
✅ **`Sepete Ekle` ve `Favorilere Ekle` butonları eklenmiştir.**
...
### **Ne İşe Yarar?**
✅ **Kargo firması ve teslimat süresi hakkında bilgi verir.**  
✅ **Mevcut kampanyalar için dinamik alanlar oluşturur.**  

---

## **6. Ürün Açıklaması ve Yorumlar Bölümü**
...
### **Ne İşe Yarar?**
✅ **Ürün açıklamasını ve kullanıcı yorumlarını gösterir.**  
✅ **Yorumlar dinamik olarak listelenebilir.**  
...
Bu eğitimde, **ürün detay sayfasının nasıl oluşturulacağını, sepete ekleme işlemlerini, resim galerisi ve yorumların nasıl yönetileceğini öğrendiniz.** Şimdi, **bu bilgileri kullanarak kendi ürün detay sayfanızı özelleştirebilirsiniz!** 🚀
